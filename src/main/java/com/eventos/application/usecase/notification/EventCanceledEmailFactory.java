...
@Component
public class EventCanceledEmailFactory {
    ...
    public String subject(Event event) {
        ...
        return "Cancelación del evento – " + nombre;
    }
    ...
    public String buildHtml(Event event) {
        ...
        vars.put("EVENTO_INICIO", event != null && event.getFechaInicio() != null ? FMT.format(event.getFechaInicio()) : "N/A");
        // FIN no se usa en la plantilla de cancelación
        return SimpleTemplateEngine.renderFromClasspath("templates/email/evento_cancelado.html", vars);
    }
}
